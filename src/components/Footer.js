          ...
          <div class="lg:flex">
            <div class="w-full -mx-6 lg:w-2/5">
              <div class="px-6">
                ...
                <div class="flex mt-4 -mx-2">
                  <a
                    href="#"
                    class="mx-2 text-white dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400"
                    aria-label="Linkden"
                  >
            ...
            <div class="mt-6 lg:mt-0 lg:flex-1">
              <div class="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4">
                <div>
                  <h3 class="text-white-700 uppercase text-white">About</h3>
                  <a
                    href="#"
                    class="block mt-2 text-sm text-gray-600 text-white hover:underline"
                  >
                    Company
                  </a>
                  <a
                ...
                <div>
                  <h3 class="text-gray-700 uppercase text-white">Blog</h3>
                  <a
                    href="#"
                    class="block mt-2 text-sm text-gray-600 text-white hover:underline"
                  >
