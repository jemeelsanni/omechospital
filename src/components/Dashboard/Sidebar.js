...
const Sidebar = () => {
  const navigation = [
    { name: "Add Profile", href: "/add", current: false },
    { name: "Doctors Profile", href: "/profiles", current: false },
  ];
  ...
  return (
    <div>
      {/* <div className="md:w-[300px] fixed hidden lg:flex flex-col items-center h-[160vh] bg-purple ">
