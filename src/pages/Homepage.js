              ...
              <div className="container flex-1 rounded-lg overflow-hidden shadow-sm relative">
                <div className="container h-auto w-full object-cover relative text-center">
                  <div className=" text-center absolute top-1/8 ">
                    ...
                    <p className="mt-3 text-lg dark:text-coolGray-400 text-white">
                      OMEC has the best equipment to give you the clinical
                      service you deserve
                    </p>
                  </div>
                  <div aria-hidden="true" className=" ">
                ...
                >
                  ...
                  <div className="p-6 space-y-2">
                    ...
                    <p>
                      ...
                      optic nerve and can result in vision loss and blindness.
                      However, with early detection and treatment, you can often
              ...
              <div className="container flex-1 rounded-lg overflow-hidden shadow-sm relative">
                ...
                >
                  ...
                  <div className="p-6 space-y-2">
                    ...
                    <h3 className="text-2xl font-semibold ">Cataract</h3>
                    <span className="text-xs dark:text-coolGray-400">
                      January 22, 2021
                    </span>
                    <p>
                      ] Cataract is any opacity of the lens of the eye. It may
                      or may not affect vision. Cataract is the major cause of
                      blindness and visual impairment worldwide. Cataract is any
                      opacity of the lens of the eye. It may or may not affect
                      vision. Cataract is the major cause of blindness and
              ...
              <div className="container flex-1 rounded-lg overflow-hidden shadow-sm relative">
                ...
                >
                  ...
                  <div className="p-6 space-y-2">
                    ...
                    <p>
                      It is a symptom of abnormal intolerance to light. It is an
                      experience of discomfort or pain to the eyes due to light
                      exposure or by presence of actual physical sensitivity of
                      the eyes. Photophobia is a fairly common symptom. Severe
                      photophobia may occur with eye problems and can cause
                      severe eye pain even in relatively low light.
                    </p>
                  </div>
                </a>
              </div>
