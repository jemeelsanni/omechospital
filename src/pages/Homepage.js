...
import optical from "../images/opticalgrid.jpg";
import clinical from "../images/clinicalgrid.png";
import eyecare from "../images/eyecaregrid.png";
import outreach from "../images/outreachgrid.png";
import surgical from "../images/surgicalgrid.png";
import training from "../images/traininggrid.png";
...
const Homepage = () => {
  return (
    <div>
      ...
      <div>
        {/**Welcome Stops here */}
        <div className="text-black flex flex-col lg:flex-row justify-around mt-3">
          <div class=" hero-content text-neutral-content">
            <div class="max-w-md text-black text-center lg:text-left ">
              <h1 class="mb-2 text-3xl font-bold ">Opeyemi Mega Eye Center </h1>
              <p class="mb-2">
          ...
          <div className="bg-black p-6">
            <div class="space-y-3 text-white bg-black px-6 py-12 border-solid border-3 border-white">
              ...
              <li>Sunday: Surgery</li>
            </div>
          </div>
        </div>
        {/**Services Starts here */}
        <section className="mt-20">
          <div className=" m-[auto] max-w-6xl items-center space-y-6 sm:space-y-12 ">
            <div>
              <h1 class="uppercase text-3xl font-light text-center text-gray-800  lg:text-4xl italic">
                Services
              </h1>
            </div>
            <div className="grid items-center grid-cols-1 gap-14 sm:grid-cols-2 lg:grid-cols-3">
              <div className=" flex flex-col h-full w-full object-cover items-center text-center">
                <div aria-hidden="true" className=" ">
                  <img src={optical} alt="" className="h-30 w-30 " />
                </div>
                <div className="mt-4 justify-self-auto  top-1/8 ">
                  <h3 className=" uppercase text-xl font-normal tracking-tight sm:text-3xl dark:text-coolGray-50 text-black">
                    Opticals
                  </h3>
                  <p className="mt-3 text-lg dark:text-coolGray-400 text-black italic">
                    Our Optometrists are here to serve you with the highest
              ...
              <div className=" flex flex-col h-full w-full object-cover items-center text-center ">
                <div aria-hidden="true" className=" ">
                  <img src={clinical} alt="" className="h-30 w-30 " />
                </div>
                <div className="mt-4 justify-self-auto  top-1/8 ">
                  <h3 className="uppercase text-xl font-normal tracking-tight sm:text-3xl dark:text-coolGray-50 text-black">
                    clinical services
                  ...
                  <p className="mt-3 text-lg dark:text-coolGray-400 text-black italic">
                    OMEC has the best equipment to give you the clinical service
                    you deserve
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col h-full w-full object-cover items-center text-center">
                <div aria-hidden="true" className="">
                  <img src={surgical} alt="" className="h-30 w-30" />
                </div>
                <div className="mt-4 justify-self-auto  top-1/8 ">
                  <h3 className="uppercase text-xl font-normal tracking-tight sm:text-3xl dark:text-coolGray-50 text-black">
                    surgical hands
                  ...
                  <p className="mt-3 text-lg dark:text-coolGray-400 text-black italic">
                    Be in the safest hands of our Ophthalmologists as they
                    perfect your vision using top-notch corrective measures
                  </p>
                </div>
              </div>
              ...
              <div className=" flex flex-col h-full w-full object-cover items-center text-center">
                <div aria-hidden="true" className=" ">
                  <img src={outreach} alt="" className="h-30 w-30 " />
                </div>
                <div className="mt-4 justify-self-auto  top-1/8 ">
                  <h3 className=" uppercase text-xl font-normal tracking-tight sm:text-3xl dark:text-coolGray-50 text-black">
                    outreach
                  ...
                  <p className="mt-3 text-lg dark:text-coolGray-400 text-black italic">
                    OMEC vision is to make a quiet impact in the field of sight
                    restoration and prevention of blindness in Nigeria
                  </p>
                </div>
              </div>
              ...
              <div className=" flex flex-col h-full w-full object-cover items-center text-center">
                <div aria-hidden="true" className=" ">
                  <img src={eyecare} alt="" className="h-30 w-30 " />
                </div>
                <div className="mt-4 justify-self-auto  top-1/8 ">
                  <h3 className="uppercase text-xl font-normal tracking-tight sm:text-3xl dark:text-coolGray-50 text-black">
                    Eye care measures
                  ...
                  <p className="mt-3 text-lg dark:text-coolGray-400 text-black italic">
                    Your eyes are important part of your health. There are many
                    things you can do to keep you seeing at your best.
                  </p>
                </div>
              </div>
              ...
              <div className=" flex flex-col h-full w-full object-cover items-center text-center">
                <div aria-hidden="true" className=" ">
                  <img src={training} alt="" className="h-30 w-30 " />
                </div>
                <div className=" mt-4 justify-self-auto  top-1/8 ">
                  <h3 className="uppercase text-xl font-normal tracking-tight sm:text-3xl dark:text-coolGray-50 text-black">
                    training
                  ...
                  <p className="mt-3 text-lg dark:text-coolGray-400 text-black italic">
                    OMEC offers three training options for postgraduate study
                    and training for aspiring Community Ophthalmic Nurses and
                    technicians.
                  </p>
                </div>
              </div>
        ...
        {/**Services ends here */}
        {/**Explore starts */}
        <section class="bg-black dark:bg-gray-900 mt-6 ">
